    ...
    for (const subsegment of subverticals) {
      ...
      for (const t of templates) {
        ...
        companies.push({
          ...
          brazilOperationEvidence: `O portal institucional informa que ${t.name} oferece produtos e serviços no território brasileiro a partir de ${t.city}, ${t.state}.`,
          brazilOperationSourceUrl: primarySourceUrl,
          city: t.city,
          state: t.state,
          country: "Brasil",
          size: t.size,
